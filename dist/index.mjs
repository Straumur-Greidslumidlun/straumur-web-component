...
import { useRef as useRef2, useState as useState4, useEffect as useEffect2 } from "preact/hooks";
...
// src/components/tooltip/tooltip.tsx
import { useRef, useState as useState2 } from "preact/hooks";
...
function CardComponent({ configuration, paymentMethods }) {
  const cardElementRef = useRef2(null);
  const adyenCardRef = useRef2();
  const customCardRef = useRef2();
  ...
  const storePaymentMethodRef = useRef2(false);
  ...
  return /* @__PURE__ */ h16("label", { className: "straumur__card-component" }, /* @__PURE__ */ h16(
  ...
  ), /* @__PURE__ */ h16("span", { className: "straumur__card-component__content" }, /* @__PURE__ */ h16("span", { className: "straumur__card-component--circle" }), /* @__PURE__ */ h16(card_default, null), /* @__PURE__ */ h16("span", { className: "straumur__card-component--text" }, i18n(configuration.locale, "cards.title")), /* @__PURE__ */ h16("span", { className: "straumur__card-component--brands" }, /* @__PURE__ */ h16(RenderBrandIcons, { brands, brandHidden }))), /* @__PURE__ */ h16(
    "div",
    {
    ...
    !isPaymentMethodInitialized.card && /* @__PURE__ */ h16("div", { className: "straumur__card-component__loading-text" }, /* @__PURE__ */ h16(loader_default, null)),
    /* @__PURE__ */ h16(
      "div",
      {
...
function GooglePayComponent({ configuration, paymentMethods }) {
  const googlePayElementRef = useRef3(null);
  const adyenCardRef = useRef3();
  const googlePayRef = useRef3();
  const {
    activePaymentMethod,
    setActivePaymentMethod,
    isPaymentMethodInitialized,
...
function ApplePayComponent({ configuration, paymentMethods }) {
  const applePayElementRef = useRef4(null);
  const adyenCardRef = useRef4();
  const applePayRef = useRef4();
  const {
    activePaymentMethod,
    setActivePaymentMethod,
    isPaymentMethodInitialized,
...
import { useEffect as useEffect5, useRef as useRef5, useState as useState5 } from "preact/hooks";
...
function StoredCardComponent({
  ...
  return /* @__PURE__ */ h22("label", { className: "straumur__stored-card-component" }, /* @__PURE__ */ h22(
    ...
    !isStoredCardInitialized[storedPaymentMethod.id] && /* @__PURE__ */ h22("div", { className: "straumur__stored-card-component__loading-text" }, /* @__PURE__ */ h22(loader_default, null)),
    /* @__PURE__ */ h22(
      "div",
      {
...
function StoredCardContainerComponent({
  ...
  if (!storedPaymentMethods || storedPaymentMethods?.length === 0 || activePaymentMethod !== "storedcard" && threeDSecureActive) {
    return null;
  }
